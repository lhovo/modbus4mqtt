...
port: 502
connection_retry: 0
disconnect_between_sample: false
update_rate: 5
address_offset: 0
variant: sungrow
scan_batching: 100
...
| connection_retry | Optional | 0 | The number of seconds to back off when a modbus error occurs, this will cause a disconnect and reconnect event. <br /> 0 = connection_retry disabled |
| disconnect_between_sample | Optional | false | Disconnect the modbus connection between samples to allow other clients to connect and read from the bus |
